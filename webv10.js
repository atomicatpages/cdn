  ...
  RA_raOnDocumentClick = async function (t) {
    ...
    if (e) {
     ...
     if(configData.oclk){     
        ...
        t.preventDefault(),
        void (raIsElementMapped(t.target) ? raLogClickAndMaybeGo(r, "link", a, !0, t.target) : raNavigate(r, a))
      }
    }
      ...
      await regclick(n);     
     if(configData.oclk){  
      const i = r.getAttribute("data-target") || r.getAttribute("target") || "_self";
      r.hasAttribute("data-href") && r.setAttribute("data-href", n),
      r.hasAttribute("href") && r.setAttribute("href", n),
      t.preventDefault(),
      raIsElementMapped(t.target) ? raLogClickAndMaybeGo(n, "button", i, !0, t.target) : raNavigate(n, i)
     }
    }
